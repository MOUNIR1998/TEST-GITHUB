...
WHERE 
    date_vente IS NOT NULL OR temps_vente IS NOT NULL OR id_client IS NOT NULL OR 
    sexe IS NOT NULL OR age IS NOT NULL OR categorie IS NOT NULL OR 
    quantite IS NOT NULL OR prix_par_unite IS NOT NULL OR cout_marchise_vendu IS NOT NULL;
